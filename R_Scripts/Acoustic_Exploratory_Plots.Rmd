...
p.splbb<- ggplot(data =SPL_BB.hr.long, aes(x=as.numeric(Hour), y=Broadband_SPL)) + geom_line(aes(color=as.character(Site))) + xlab("Hour") + ylab ("BB_SPL") + scale_color_brewer(palette = "Set1") +
  theme(legend.position = "none")
