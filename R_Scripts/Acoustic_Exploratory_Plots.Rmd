...
#converting date to character
SPL_HF17$Date <- as.character(SPL_HF17$Date)
...
#converting date to character
SPL_HF18$Date <- as.character(SPL_HF18$Date)
...
#converting date to character
SPL_MF17$Date <- as.character(SPL_MF17$Date)
...
#converting date to character
SPL_MF18$Date <- as.character(SPL_MF18$Date)
