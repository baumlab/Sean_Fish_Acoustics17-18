...
SPL_BBp <- ggplot(data = AC.DF1, aes(y = SPL_BB, x = Hour, fill = Year)) + geom_boxplot() + ylab("BB_SPL") + xlab("Hour")

SPL_HFp <- ggplot(data = AC.DF1, aes(y = SPL_HF, x = Hour, fill = Year)) + geom_boxplot() + ylab("HF_SPL") + xlab("Hour")

SPL_MFp <- ggplot(data = AC.DF1, aes(y = SPL_Midrange, x = Hour, fill = Year)) + geom_boxplot() + ylab("MF_SPL") + xlab("Hour")

Tot_Kp <- ggplot(data = AC.DF1, aes(y = Tot_Knocks, x = Hour, fill = Year)) + geom_boxplot() + ylab("Knocks") + xlab("Hour")

LCp <- ggplot(data = AC.DF1, aes(y = Num_L_calls, x = Hour, fill = Year)) + geom_boxplot() + ylab("Long Calls") + xlab("Hour")

Herbp <- ggplot(data = AC.DF1, aes(y = Num_Herbivory, x = Hour, fill = Year)) + geom_boxplot() + ylab("Herbivory") + xlab("Hour")

Snapp <- ggplot(data = AC.DF1, aes(y = Snaps, x = Hour, fill = Year)) + geom_boxplot() + ylab("Snaps") + xlab("Hour")

hour_bp <- plot_grid(SPL_BBp, SPL_HFp, SPL_MFp, Tot_Kp, LCp, Herbp, Snapp, nrow = 2, ncol = 4)
hour_bp
...
SPL_BBp1 <- ggplot(data = AC.DF1, aes(y = SPL_BB, x = Site, fill = Year)) + geom_boxplot() + ylab("BB_SPL") + xlab("Site")

SPL_HFp1 <- ggplot(data = AC.DF1, aes(y = SPL_HF, x = Site, fill = Year)) + geom_boxplot() + ylab("HF_SPL") + xlab("Site")

SPL_MFp1 <- ggplot(data = AC.DF1, aes(y = SPL_Midrange, x = Site, fill = Year)) + geom_boxplot() + ylab("MF_SPL") + xlab("Site")

Tot_Kp1 <- ggplot(data = AC.DF1, aes(y = Tot_Knocks, x = Site, fill = Year)) + geom_boxplot() + ylab("Knocks") + xlab("Site")

LCp1 <- ggplot(data = AC.DF1, aes(y = Num_L_calls, x = Site, fill = Year)) + geom_boxplot() + ylab("Long Calls") + xlab("Site")

Herbp1 <- ggplot(data = AC.DF1, aes(y = Num_Herbivory, x = Site, fill = Year)) + geom_boxplot() + ylab("Herbivory") + xlab("Site")

Snapp1 <- ggplot(data = AC.DF1, aes(y = Snaps, x = Site, fill = Year)) + geom_boxplot() + ylab("Snaps") + xlab("Site")

site_bp <- plot_grid(SPL_BBp1, SPL_HFp1, SPL_MFp1, Tot_Kp1, LCp1, Herbp1,Snapp1, nrow = 2, ncol = 4)
site_bp
