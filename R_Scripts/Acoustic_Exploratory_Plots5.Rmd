...
fit.m <- lm(SPL_Midrange ~(Tot_Knocks + Num_Herbivory + Num_L_calls)*(Site + Hour_factor) + Year, data = AC.DF1Co)
summary(fit.m)
...
fit.m2 <- lm(SPL_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + Site + Hour_factor + Year + Tot_Knocks:Site + Tot_Knocks:Hour_factor + Num_Herbivory:Site + Num_L_calls:Site, data = AC.DF1Co)
...
fit.a <- glm(ACI_Midrange ~(Tot_Knocks + Num_Herbivory + Num_L_calls)*(Site + Hour_factor) + Year, data = AC.DF1Co, family = "Gamma")
summary(fit.a)
stepAIC(fit.a)
plot(fit.a)
...
#ACI_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + Site + Year + Num_Herbivory:Site

fit.a2 <- glm(ACI_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + Site + Num_Herbivory:Site, data = AC.DF1Co, family = "Gamma")
summary(fit.a2)
...
AICc(fit.tg, fit.dn, fit.ns)


```

Quartering the day was the best model, using time groups 0-5, 6-11, 12-17, 18-23
