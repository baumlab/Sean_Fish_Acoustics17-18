...
SP.mf1.1 <- ggplot(AC.DF1, aes(Tot_Knocks, SPL_Midrange)) + geom_point(aes(color = Site))
SP.mf1.2 <- ggplot(AC.DF1, aes(Tot_Knocks, SPL_Midrange)) + geom_point(aes(color = Hour))


SP.mf2 <- ggplot(AC.DF1, aes(Num_L_calls, SPL_Midrange)) + geom_point()
SP.mf2.1 <- ggplot(AC.DF1, aes(Num_L_calls, SPL_Midrange)) + geom_point(aes(color = Site))
SP.mf2.2 <- ggplot(AC.DF1, aes(Num_L_calls, SPL_Midrange)) + geom_point(aes(color = Hour))
...
SP.hf2 <- ggplot(Snap.HF17, aes(Snaps, SPL_HF)) + geom_point(aes(color=Site.x))
...
##Patterns in MF and Tot_Knocks at Site and Hour Level
...
SPmf.35 <- ggplot(s35, aes(Tot_Knocks, SPL_Midrange)) + geom_point(color = "Yellow") + ggtitle("Site 35")

SPmf.40 <- ggplot(s40, aes(Tot_Knocks, SPL_Midrange)) + geom_point(color = "Red") + ggtitle("Site 40")

SPmf.8 <- ggplot(s8, aes(Tot_Knocks, SPL_Midrange)) + geom_point(color = "Yellow") + ggtitle("Site 8")
...
SPmf.h9 <- ggplot(h9, aes(Tot_Knocks, SPL_Midrange)) + geom_point() + ggitle("9 AM")
SPmf.h9
...
##Patterns in HF and Snaps at Site Level
```{r patternsHF&Snaps, echo = FALSE}
SP.t1 <- ggplot(Snap.HF17, aes(Time.x, Snaps)) + geom_point(aes(color = Site.x))
SP.t1
#splitting snaps by site
#splitting dataframe by site
s5 <- filter(Snap.HF17, Site.x == "5")
s32 <- filter(Snap.HF17, Site.x == "32")
s35 <- filter(Snap.HF17, Site.x == "35")
s40 <- filter(Snap.HF17, Site.x == "40")
s8 <- filter(Snap.HF17, Site.x == "8")

#plotting by site
SP.t5 <- ggplot(s5, aes(Time.x, Snaps)) + geom_point(color = "Green") + ggtitle("Site 5")

SP.t32 <- ggplot(s32, aes(Time.x, Snaps)) + geom_point(color = "Red" ) + ggtitle("Site 32")

SP.t35 <- ggplot(s35, aes(Time.x, Snaps)) + geom_point(color = "Orange") + ggtitle("Site 35")

SP.t40 <- ggplot(s40, aes(Time.x, Snaps)) + geom_point(color = "Red") + ggtitle("Site 40")

SP.t8 <- ggplot(s8, aes(Time.x, Snaps)) + geom_point(color = "Orange") + ggtitle("Site 8")
...
#running basic regressions linking exp. to resp. at site and hour level
