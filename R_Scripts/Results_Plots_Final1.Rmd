...
aci.hf <- lmer(ACI_HF ~ Snaps + (1|Site/Year), data = Snap.HF)
...
aci.hf1a <- lmer(ACI_HF ~ dn + (1|Site/Year), data = Snap.HF)
...
aci.hf2 <- lmer(ACI_HF ~ Snaps + dn + (1|Site/Year) , data = Snap.HF)
...
The most parsimonious model here is aci.hf2, because it is the simplest model out of that and aci.hf2 and aci.hf4 which have ACI scores within 2 of eachother. 
...
simple1amf <- lmer(SPL_Midrange ~ Tot_Knocks + (1|Site/Year), data = AC.DF1Co)
...
simple1bmf <- lmer(SPL_Midrange ~ Num_L_calls + (1|Site/Year), data = AC.DF1Co)
...
simple1cmf <- lmer(SPL_Midrange ~ Num_Herbivory + (1|Site/Year), data = AC.DF1Co)
...
simple2amf <- lmer(SPL_Midrange ~ Tot_Knocks + Num_Herbivory + (1|Site/Year), data = AC.DF1Co)
...
simple2bmf <- lmer(SPL_Midrange ~ Tot_Knocks + Num_L_calls + (1|Site/Year), data = AC.DF1Co)
...
simple2cmf <- lmer(SPL_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + (1|Site/Year), data = AC.DF1Co)

summary(simple2cmf)

```

Model failed to converge. Knocks is all that is significant, still has a tiny effect size.
...
simple3mf <- lmer(SPL_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + Hour + (1|Site/Year), data = AC.DF1Co)
...
simple4mf <- lmer(SPL_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + Hour + Tot_Knocks:Hour + (1|Site/Year), data = AC.DF1Co)
...
simple6amf <- lmer(SPL_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + Hour + (1|Site/Year) + Tot_Knocks:Hour + Num_Herbivory:Hour, data = AC.DF1Co)
...
AICc(simple1amf, simple1bmf, simple1cmf, simple2amf, simple2bmf, simple2cmf, simple3mf, simple4mf, simple6amf, simple6bmf, simple7mf, reducemf, reducemf2, reducemf3, reducemf4, reducemf5, reducemf6)

summary(reducemf4)
```

Best models are reducemf4 and reducemf6.

reducemf4 includes: Knocks + Hour + Knocks*Hour + (1|Site/Year)

reducemf6 includes: Knocs + Hour + Knocks*Hour + Num_Herbivory + (1|Site/Year)

Therefore my most parsimonious model is reducemf4.
...
mf.aci1 <- lmer(ACI_Midrange ~ Tot_Knocks + (1|Site/Year), data = AC.DF1Co)
summary(mf.aci1)
...
mf.aci2a <- lmer(ACI_Midrange ~ Tot_Knocks + Num_Herbivory + (1|Site/Year), data = AC.DF1Co)
summary(mf.aci2a)
...
mf.aci2b <- lmer(ACI_Midrange ~ Tot_Knocks + Num_L_calls + (1|Site/Year), data = AC.DF1Co)
summary(mf.aci2b)
...
mf.aci3 <- lmer(ACI_Midrange ~ Tot_Knocks + Num_Herbivory + Num_L_calls + (1|Site/Year), data = AC.DF1Co)
summary(mf.aci3)
...
mf.aci4 <- lmer(ACI_Midrange ~ Tot_Knocks + Hour + (1|Site/Year), data = AC.DF1Co)
summary(mf.aci4)

#maximal model
mf.maxaci <- lmer(ACI_Midrange ~ (Tot_Knocks + Num_L_calls + Num_Herbivory)*Hour + (1|Site/Year), data = AC.DF1Co)

#reduced models
mf.acil <- lmer(ACI_Midrange ~ Num_L_calls + (1|Site/Year), data = AC.DF1Co)

mf.acih <- lmer(ACI_Midrange ~Num_Herbivory + (1|Site/Year), data = AC.DF1Co)

mf.acilh <- lmer(ACI_Midrange ~ Num_L_calls*Hour + (1|Site/Year), data = AC.DF1Co)

mf.acihh <- lmer(ACI_Midrange ~ Num_Herbivory*Hour + (1|Site/Year), data = AC.DF1Co)
...
fit.mfaci6 and mf.maxaci are the two best models.

fit.mfaci6 is the most parsimonious model.

Knocks + Herbivory + Long Calls + Hour + (1|Site/Year)
