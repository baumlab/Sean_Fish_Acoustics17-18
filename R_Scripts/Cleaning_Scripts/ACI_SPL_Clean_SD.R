...
#pulling columns before merge
ACI_HF_32.17 <- s32.17 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_35.17 <- s35.17 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_40.17 <- s40.17 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_5.17 <- s5.17 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_8.17 <- s8.17 %>% dplyr::select(ACI_HF, Date, Time)
...
#2018
#pulling columns before merge
ACI_HF_32.18 <- s32.18 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_35.18 <- s35.18 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_40.18 <- s40.18 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_5.18 <- s5.18 %>% dplyr::select(ACI_HF, Date, Time)
ACI_HF_8.18 <- s8.18 %>% dplyr::select(ACI_HF, Date, Time)
