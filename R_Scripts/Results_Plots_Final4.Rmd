...
hf.dplot <- ggplot(SPLHF.long518, aes(x=Time, y=SPL_HF)) + geom_point() + theme( legend.position = "none") + 
  labs(y = "High Frequency", title = "SPL") + scale_x_discrete(breaks = c("00:00", "03:00", "06:00", "09:00", "12:00", "15:00", "18:00", "21:00")) +  
  theme_cowplot() + 
...
#ggsave(file = "../Figures/Fourplot_FINAL.pdf", width = 11, height = 7, four.plot)
four.plot
```
