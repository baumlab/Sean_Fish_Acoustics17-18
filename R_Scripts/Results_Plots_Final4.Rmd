...
SP2.hf <- ggplot(Snap.HF5, aes(Snaps, SPL_HF, color = t12)) + geom_point(size = 0.5) + labs(color = "Day/Night") + scale_color_discrete(labels = c("Night", "Day")) + theme_classic() + labs(y = "High Frequency SPL")+ geom_abline(intercept = 87.37, slope = 0.021, col = "red") + geom_abline(intercept = 92.94, slope = 0.016, col = "blue")
