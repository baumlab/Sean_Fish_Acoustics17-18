...
knocks.bp <- ggplot(sel.tbl, aes(Hour, RL)) + geom_boxplot() + theme_classic() + ylab("Knock Volume (dB)") + 
...
#ggsave(file = "../Figures/knocksbp.pdf", width = 11, height = 7, knocks.bp)
...
#ggsave(file = "../Figures/knockci.pdf", width = 11, height = 7, knock.ci)
...
mfa.dplot.F <- mfa.dplot.F + theme_cowplot() + labs(y = "AIC 0.16-1 kHz")
