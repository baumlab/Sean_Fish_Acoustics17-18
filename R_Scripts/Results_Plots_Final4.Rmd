...
mf.dplot.F <- mf.dplot.F + theme_classic() + ylab("Low Frequency SPL")
...
hfa.dplot <- hfa.dplot + scale_x_discrete(breaks = c("03:00", "06:00", "09:00", "12:00", "15:00", "18:00", "21:00")) + theme_classic() + labs(y = "High Frequency ACI", x = "Time") +  theme(axis.title.x = element_blank(), axis.text.x = element_blank())
hfa.dplot
