...
#ACI and snaps
#AC2.hf <- ggplot(Snap.HF5s, aes(Snaps, ACI_HF)) + geom_point(size = 1.2) + geom_smooth(method = "lm", se=F) + theme_classic() + labs(y = "High Frequency ACI")
#AC2.hf
...
SP.mf <- ggplot(AC.DF1, aes(Tot_Knocks, SPL_Midrange,color = Hour, shape = Hour)) + 
  ...
  geom_abline(intercept = 104.909369, slope = -0.017715, col = "#E69F00") + 
  geom_abline(intercept = 105.9475, slope = 0.000474, col = "#56B4E9")
SP.mf
