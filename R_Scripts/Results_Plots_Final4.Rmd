...
ctbl <- coef(summary(reducemf4))[,"Estimate"]
ctbl2 <- coef(summary(reducemf6))[,"Estimate"]
ctbl3 <- coef(summary(reducemf3))[, "Estimate"]
ctbl4 <- coef(summary(simple4mf))[, "Estimate"]

suptbl1 <- bind_rows(ctbl, ctbl2, ctbl3, ctbl4)

#write.csv(suptbl1, file = "../Raw_Data/suptbl1.csv")

r1 <- data.frame(r.squaredGLMM(reducemf6))
r2 <- data.frame(r.squaredGLMM(reducemf4))
r3 <- data.frame(r.squaredGLMM(reducemf3))
r4 <- data.frame(r.squaredGLMM(simple4mf))
