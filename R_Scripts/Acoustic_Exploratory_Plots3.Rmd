...
```{r supp plots, echo = FALSE, fig.width = 20, fig.length = 30}
#High frequency
...
Using only the two interactions that are significant, Tot_Knocks:Hour and Num_Herbiory:Hour
``` {r model 6, echo = TRUE}

gfit6 <- lmer(SPL_Midrange ~ Tot_Knocks:Hour_factor + Num_L_calls + Num_Herbivory:Hour_factor + (1|Site), data = AC.DF1Co)
