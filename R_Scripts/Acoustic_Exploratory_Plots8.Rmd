...
IP4 <- interaction.plot(Snap.HF$t12, Snap.HF$Site, Snap.HF$ACI_HF)
...
SP2.hf <- ggplot(Snap.HF5, aes(Snaps, SPL_HF)) + geom_point(aes(color=t12))
SP2.hf
```
...
#Just site 5 at 9 am
SP.mf9 <- ggplot(h9, aes(Tot_Knocks, SPL_Midrange)) + geom_point(aes(color = Site))
SP.mf9
```
...
#High frequency
hf.dplot <- ggplot(SPLHF.long518, aes(x=Time, y=SPL_HF)) + geom_point() + theme(axis.text.x = element_text(angle = 90), legend.position = "none")
hf.dplot + scale_x_discrete(breaks = c("00:00", "03:00", "06:00", "09:00", "12:00", "15:00", "18:00", "21:00"))
...
mf.dplot + scale_x_discrete(breaks = c("00:00", "03:00", "06:00", "09:00", "12:00", "15:00", "18:00", "21:00"))
...
hfa.dplot <- ggplot(Snap.HF, aes(x=Time, y =ACI_HF)) + geom_point(aes(color = t12)) + theme(axis.text.x = element_text(angle = 90), legend.position = "none")
hfa.dplot + scale_x_discrete(breaks = c("00:00", "03:00", "06:00", "09:00", "12:00", "15:00", "18:00", "21:00"))
