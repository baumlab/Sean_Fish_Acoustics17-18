...
aci.hf2 includes: Snaps + dn + (1|Site) + Year

aci.hf4 includes: Snaps*dn + (1|Site) + Year
...
reducemf6 is the best model.

reducemf6 includes: Tot_Knocks + Hour + Tot_Knocks:Hour + Num_Herbivory + (1 | Site) + Year
...
mf.acihh is the best model.

mf.acihh includes Num_Herbivory*Hour + (1|Site) + Year
